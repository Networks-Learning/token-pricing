...
if __name__ == "__main__":
    ...
    with open(f"../outputs/heur/heuristic_model_{model_str}_T_{args.temperature}_splits_{args.splits}_numseq_{args.num_seq}_p_{top_p}_k_{top_k}_prompt_id{args.prompts[0][0:8]}.pkl", "wb") as f:
